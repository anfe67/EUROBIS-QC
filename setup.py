...
setup(name="eurobisqc",
      version="0.5.0",
      python_requires='>=3.6',
      data_files=[('dbworks/resources', ['dbworks/resources/config.ini',
                                         ...
                                         'dbworks/resources/weightMeasurementTypeLookup',
                                         'dbworks/resources/deviceMeasurementTypeIDLookup',
                                         'dbworks/resources/deviceMeasurementTypeLookup',
